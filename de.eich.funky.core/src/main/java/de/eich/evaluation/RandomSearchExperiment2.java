...
//import de.eich.gui.DependenceTableView;
...
public class RandomSearchExperiment2 {

	private static final Logger log = LoggerFactory.getLogger(RandomSearchExperiment2.class);
	
	public static void main(String[] args) {
		log.info("Strating random search experiment 2");
		test(400);
	}
...
//			new DependenceTableView(rewriter1);
